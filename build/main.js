...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__form_modal__ = __webpack_require__(623);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic_angular__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__calendarUserCalendar_Model__ = __webpack_require__(610);
...
var AuthManagerProvider = /** @class */ (function () {
    ...
    AuthManagerProvider.prototype.login = function (mail, password, callback) {
        ...
        this.http.postBackendGetOAuthToken(mail, password, function (success, data) {
            ...
            if (success) {
                ...
                _this.guiManager.showPopupMessage("Anmeldung nicht möglich", "Bitte stellen Sie sicher, dass Ihr Handy über eine Internetverbindung verfügt und versuchen Sie es erneut.<br/><br/>Fehler: " + answer.message);
    ...
    AuthManagerProvider.prototype.internalPostLogin = function (key, isMedical, mail, userGroup, clinicName, clinicId, registered) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_9__services_statics__["a" /* Info */].projectId == 'wzk') {
            if ((this.registered == null || __WEBPACK_IMPORTED_MODULE_9__services_statics__["a" /* Info */].showCalendarAfter == null)
    ...
    AuthManagerProvider.prototype.internalPostLogin_new = function (tokenInfo /*, key, isMedical, mail, userGroup, clinicName, clinicId, registered = null*/) {
        ...
        this.storage.save("token_info", tokenInfo, function () {
            ...
            if (__WEBPACK_IMPORTED_MODULE_9__services_statics__["a" /* Info */].projectId == 'wzk') {
                if ((_this.registered == null || __WEBPACK_IMPORTED_MODULE_9__services_statics__["a" /* Info */].showCalendarAfter == null) || (_this.registered != null && (_this.registered < __WEBPACK_IMPORTED_MODULE_9__services_statics__["a" /* Info */].showCalendarAfter)) || clinicId != 115) {
                    //          this.guiManager.removeByName("Anwendungen", "Terminplaner");
                    //          this.guiManager.removeTileByName("Terminplaner");
                }
            }
    ...
    AuthManagerProvider.prototype.registerWithInvitationNumber = function (email, password, passsword2, code, callback) {
        var data = JSON.stringify({ key: code, mail: email, pass: password, pass2: passsword2 });
    ...
    AuthManagerProvider.prototype.registerWithFallnummer = function (email, password, passsword2, fallnummer, birthday, callback) {
        var data = JSON.stringify({ fallnummer: fallnummer, birthday: birthday, mail: email, pass: password, pass2: passsword2 });
        //    this.register(data, email, callback);
    ...
    AuthManagerProvider.prototype.register_new = function (data, email, callback) {
        ...
        this.http.postBackend("/rest/app/users/register", data, [], function (success, data) {
            ...
            if (success) {
                ...
                callback(false);
                _this.guiManager.showPopupMessage("Fehler", "Es ist ein Fehler aufgetreten. Weitere Informationen siehe unten: <b>" + answer_1.message + "</b>");
            }
        }, null, true);
    };
    /**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__ionic_native_in_app_browser__ = __webpack_require__(462);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__environments_environment__ = __webpack_require__(662);
...
var MyApp = /** @class */ (function () {
    ...
    MyApp.prototype.openPage = function (page) {
        this.nav.setRoot(page.component, page.params != null ? page.params : {}, { animate: true, direction: 'forward' });
    };
    __decorate([
...
var LinkManagerProvider = /** @class */ (function () {
    ...
    LinkManagerProvider.prototype.getNews = function (clinic) {
        ...
        return this.newsList[clinic] == undefined ? this.newsList[""] : this.newsList[clinic];
    };
    ...
    LinkManagerProvider.prototype.getWebformAsHalJSON = function (clinic) {
        ...
        return this.webforms[clinic] == undefined ? this.webforms[""] : this.webforms[clinic];
    };
    LinkManagerProvider.prototype.getInfoIdsList = function (clinic) {
        if (clinic === void 0) { clinic = ""; }
        console.log("getInfoIdsList is: " + this.infoIdsLists[clinic]);
        return this.infoIdsLists[clinic] == undefined ? this.infoIdsLists[""] : this.infoIdsLists[clinic];
    };
    LinkManagerProvider.prototype.getMenu = function (clinic) {
        if (clinic === void 0) { clinic = ""; }
        console.log("getMenu is: " + this.foodMenus[clinic]);
        return this.foodMenus[clinic] == undefined ? this.foodMenus[""] : this.foodMenus[clinic];
    };
    /**
