...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__email_confirmation__ = __webpack_require__(749);
...
var EmailConfirmation = /** @class */ (function () {
    ...
    EmailConfirmation = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-email-confirmation',template:/*ion-inline-start:"C:\ger\wzk\front\3 wzk few options\clinic_app_frontend\src\pages\email-confirmation\email-confirmation.html"*/'<ion-content class="confirmation-content" padding>\n\n    <h2><b>Bestätigungsmail</b></h2>\n    <h5 style="margin-top: 5px">Wir haben eine Bestätigungsmail an {{email}} versandt, bitte öffnen Sie den Link\n        innerhalb dieser um fortzufahren.\n    </h5>\n    <div style="margin-top: 40px">\n    </div>\n    <button ion-button full class="confirmation-button" (click)="handleCloseButton()">Weiter</button>\n\n</ion-content>'/*ion-inline-end:"C:\ger\wzk\front\3 wzk few options\clinic_app_frontend\src\pages\email-confirmation\email-confirmation.html"*/,
        }),
