...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__checkin__ = __webpack_require__(746);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__conditions__ = __webpack_require__(453);
...
var CheckinPage = /** @class */ (function () {
    ...
    CheckinPage.prototype.firstPageOptionHandle = function () {
        var nextItem = document.getElementById('element-' + 2).children[0].children[1].children[0].children;
    ...
    CheckinPage.prototype.secondPageOptionHandle = function () {
        var nextItem = document.getElementById('element-' + 1).children[0].children[1].children[0].children;
    ...
    CheckinPage.prototype.fifthPageOptionHandle = function () {
        var _this = this;
        var nextItem = document.getElementById('element-' + 0).children[0].children[1].children[0];
    ...
    CheckinPage.prototype.onButtonClick = function () {
        ...
        for (var i = 0; i < nextItem.children.length; i++) {
            ...
            if (child.tagName === 'BUTTON' && ((_a = child.textContent) === null || _a === void 0 ? void 0 : _a.trim()) === '+ Hinzufügen') {
    ...
    CheckinPage.prototype.sixthPageOptionHandle = function () {
        var nextItem = document.getElementById('element-' + 0).children[0].children[1].children[0].children;
        console.log(nextItem);
        for (var i = 0; i < nextItem.length; i++) {
            if (i !== 0) {
                nextItem[i].children[0].classList.add('disabled-item');
    ...
    CheckinPage.prototype.seventhPageOptionHandle = function () {
        ...
        var secondItem = document.getElementById('element-' + 6).children[0].children[1].children[0].children;
        ...
        var thirdItem = document.getElementById('element-' + 7).children[0].children[1].children[0].children;
        ...
        var fifthItem = document.getElementById('element-' + 9).children[0].children[1].children[0].children;
    ...
    CheckinPage.prototype.eighthPageOptionHandle = function () {
        ...
        var firstItem = document.getElementById('element-' + 4).children[0].children[1].children[0].children;
        var secondItem = document.getElementById('element-' + 5).children[0].children[1].children[0].children;
        var thirdItem = document.getElementById('element-' + 13).children[0].children[1].children[0].children;
        var fourthItem = document.getElementById('element-' + 15).children[0].children[1].children[0].children;
    ...
    CheckinPage.prototype.showMessage = function (title, message, callback) {
        if (callback === void 0) { callback = function (data) {
            console.log("On the message with title " + title + " and messsage '" + message + "'", data);
        }; }
    ...
    CheckinPage.prototype.sendDataToKISandCreatePDF = function () {
        ...
        this.loaded = false;
        this.loadingText = "Die Daten werden verschlüsselt und an die Klinik gesendet. Dies kann eine Weile dauern (ca. 20-60 Sekunden). Bitte warten Sie.";
        // -------------------------------------------------
        /*    this.loaded = true;
            this.loadingText = "";*/
        // -------------------------------------------------
    ...
    CheckinPage.prototype.onSegmentChange = function (i) {
        ...
        if (disallowedToProceed) {
            this.guiManager.showToast("Seite Nummer " + sectionIndex + " hat Pflichtfelder. Bitte füllen Sie die Pflichtfelder aus.", 5000, "warningToast");
        }
        else {
    ...
    CheckinPage.prototype.prevElement = function (elementNr, pageIndex) {
        ...
        var previous = {};
        previous = document.getElementById('element-' + wanted).parentElement.previousSibling;
        ...
        for (var i = 0; i < parent.children.length; i++) {
            ...
            if (currentItem.selfMultiply && currentItem.id.indexOf("child-") == -1) {
                ...
                var _loop_1 = function (x) {
                    if ((node.type == "checkboxes" || node.type == 'webform_checkboxes_other') && fieldKeys[x] == "values") {
    ...
    CheckinPage.prototype.showDrawer = function (path, kind, parent) {
        ...
        this.modelCtrl.create('DrawPage', { img: path, kind: kind, parent: parent }).present();
    };
    /**
    ...
    CheckinPage.prototype.shouldSkipCondition = function (index, componentIndex) {
        ...
        if (this.data.length < 9 && index === 5 && !componentIndexes.includes(componentIndex)) {
            return true;
        }
    ...
    CheckinPage.prototype.backButtonSkip = function (index, componentIndex) {
        ...
        if (this.data.length < 9 && index === 5 && !component6Indexes.includes(componentIndex)) {
            return true;
        }
        if (slidesIndex.includes(index)) {
            return true;
    ...
    CheckinPage.prototype.isElementActive = function (index, componentIndex) {
        ...
        if (this.data.length < 8 && index === 5 && this.component6Indexes.includes(componentIndex)) {
            return true;
        }
        if (slidesIndex.includes(index)) {
            return true;
    ...
    CheckinPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_11__providers_activity_tracker_activity_tracker__["a" /* ActivityTrackerProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_10__providers_gui_manager_gui_manager__["a" /* GuiManagerProvider */]])
    ], CheckinPage);
    return CheckinPage;
}());
