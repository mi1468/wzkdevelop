...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__user_settings_push_notification__ = __webpack_require__(806);
...
var UserSettingsPushNotificationPage = /** @class */ (function () {
    ...
    UserSettingsPushNotificationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-user-settings-push-notification',template:/*ion-inline-start:"C:\ger\wzk\front\3 wzk few options\clinic_app_frontend\src\pages\user-settings-push-notification\user-settings-push-notification.html"*/'<!--\n  Generated template for the UserSettingsPushNotificationPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>TestNachricht senden</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content >\n  <ion-card>\n    <ion-card-header>\n      TestNachricht senden\n    </ion-card-header>\n    <ion-card-content>\n      <p>Eine Testnachricht an dieses Handy schicken</p>\n      <button ion-button block default color="primary" (click)="pushNotif()">Abschicken</button>\n    </ion-card-content>\n  </ion-card>\n</ion-content>\n'/*ion-inline-end:"C:\ger\wzk\front\3 wzk few options\clinic_app_frontend\src\pages\user-settings-push-notification\user-settings-push-notification.html"*/,
        }),
